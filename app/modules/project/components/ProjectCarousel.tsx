...
export const ProjectCarousel = forwardRef<HTMLDivElement, ProjectCarouselProps>(
  ({ className, isTitleVisible, projects }, ref) => {
    ...
    return (
      ...
      >
        {isTitleVisible && (
          <h2 className="container mx-auto mb-4 inline-flex w-full items-center gap-2 text-xl font-semibold text-slate-800 md:mb-12 md:max-w-3xl md:justify-center md:text-4xl dark:text-slate-200">
