...
export function BrandHero({ className }: BrandHeroProps) {
  return (
    <section className={twMerge('flex w-full items-center justify-between gap-4 text-center md:flex-col-reverse', className)}>
      <div className="flex flex-col gap-2 text-left md:text-center">
        ...
        <p className="w-full text-xs md:text-sm font-light text-slate-600 dark:text-slate-400">
